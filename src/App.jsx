    ...
    <div className="swiss-grid">
      ...
      <div style={{ gridColumn: 'span 9' }}>
        ...
        <p style={{ fontFamily: '"Source Sans 3", sans-serif', fontSize: '1.25rem', lineHeight: '1.6', marginBottom: '2rem', color: 'var(--text-primary)' }}>
          The way I see it, an artist is someone who takes the senses and abilities we have as people, like hearing, sight, touch, thought, and movement, and tries to experience them as fully and honestly as possible.
        </p>
        <p style={{ fontFamily: '"Source Sans 3", sans-serif', fontSize: '1.25rem', lineHeight: '1.6', marginBottom: '2rem', color: 'var(--text-primary)' }}>
        ...
        <p style={{ fontFamily: '"Source Sans 3", sans-serif', fontSize: '1.25rem', lineHeight: '1.6', marginBottom: '2rem', color: 'var(--text-primary)' }}>
          I&apos;m studying that path seriously at UT Arlington. What keeps me motivated is building things people can <strong style={{ color: 'var(--accent-main)', fontWeight: 700 }}>See, Hear, and Connect</strong> with. I want that work to stay both technical and human, and to leave something good behind.
        </p>
        <blockquote style={{
